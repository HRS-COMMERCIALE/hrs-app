                    ...
                    <div className="text-center max-w-6xl mx-auto w-full">
                        ...
                        <div className="mb-8 transform transition-all duration-1000">
                            <div className="inline-flex items-center gap-3 bg-gradient-to-r from-[#3c959d]/15 to-[#ef7335]/15 backdrop-blur-sm border border-[#3c959d]/30 rounded-full px-6 py-3 text-sm">
                                ...
                                <span className="text-slate-200 font-medium">Choose Your Plan</span>
                            </div>
                        </div>
                        ...
                        <div className="mb-12">
                            ...
                            <p className="text-xl md:text-2xl text-slate-300 max-w-4xl mx-auto mb-12 leading-relaxed transform transition-all duration-1000">
                                ...
                                <span className="text-[#4ba5ad] font-semibold"> achieve your goals</span>
                            </p>
                    ...
                    <div className="text-center mb-16">
                        ...
                        <div className="max-w-5xl mx-auto leading-relaxed">
                            ...
                            <h4 className="text-lg md:text-xl font-semibold text-slate-700 mb-6">
                                Affordable pricing and packages for smooth billing and efficient productivity
                            </h4>
                            <p className="text-base md:text-lg text-slate-600 leading-relaxed">
                                HRSCommerciale is an online platform designed for small and medium-sized enterprises (SMEs & VSEs), offering comprehensive support in the digitization of their work processes. With advanced technologies and modules usually used by large companies, such as the finance module, human resource management, CRM, street vending, etc., HRSCommerciale helps transform their business by reducing costs and increasing revenue. All at competitive rates, promoting their growth towards new horizons.
                            </p>
                        </div>
                    </div>
